...
def LR_model(file1):
    ...
    name = "SVC"
    params_grid = [
        {'kernel': ['rbf'], 'gamma': [1e-2,1e-1, 1, 2], 'C': [0.1, 1, 10,50, 100, 150]},
        {'kernel': ['linear'], 'C': [0.1, 1, 10,50, 100, 150]},
        {'kernel': ['poly'], 'gamma': [1e-2,1e-1, 1, 2],'degree': [ 2, 3, 4, 5], 'C': [0.1, 1, 10, 50,100, 150]},
        {'kernel': ['sigmoid'], 'gamma': [1e-2,1e-1, 1, 2],'C': [0.1, 1, 10, 50,100, 150]}
    ]
    ...
    pred_data_test, pred_data_train=model_training(classifier, data_train, output_train, data_test, output_test,groups_at_training)
